...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAnimationClipWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 22, 12, 5);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getframeRate", _g_get_frameRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getwrapMode", _g_get_wrapMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlocalBounds", _g_get_localBounds);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlegacy", _g_get_legacy);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethumanMotion", _g_get_humanMotion);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getempty", _g_get_empty);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasGenericRootTransform", _g_get_hasGenericRootTransform);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasMotionFloatCurves", _g_get_hasMotionFloatCurves);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasMotionCurves", _g_get_hasMotionCurves);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gethasRootCurves", _g_get_hasRootCurves);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getevents", _g_get_events);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setframeRate", _s_set_frameRate);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setwrapMode", _s_set_wrapMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlocalBounds", _s_set_localBounds);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlegacy", _s_set_legacy);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setevents", _s_set_events);
        ...
        static int _m_SampleAnimation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SampleAnimation( 
                        _go, 
                        _time );
