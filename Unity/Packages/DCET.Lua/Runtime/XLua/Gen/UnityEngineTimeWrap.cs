...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTimeWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 51, 19, 6);
			
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "gettime", _g_get_time);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettimeSinceLevelLoad", _g_get_timeSinceLevelLoad);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdeltaTime", _g_get_deltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedTime", _g_get_fixedTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunscaledTime", _g_get_unscaledTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedUnscaledTime", _g_get_fixedUnscaledTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getunscaledDeltaTime", _g_get_unscaledDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedUnscaledDeltaTime", _g_get_fixedUnscaledDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getfixedDeltaTime", _g_get_fixedDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmaximumDeltaTime", _g_get_maximumDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getsmoothDeltaTime", _g_get_smoothDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getmaximumParticleDeltaTime", _g_get_maximumParticleDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "gettimeScale", _g_get_timeScale);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getframeCount", _g_get_frameCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrenderedFrameCount", _g_get_renderedFrameCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getrealtimeSinceStartup", _g_get_realtimeSinceStartup);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcaptureDeltaTime", _g_get_captureDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcaptureFramerate", _g_get_captureFramerate);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getinFixedTimeStep", _g_get_inFixedTimeStep);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setfixedDeltaTime", _s_set_fixedDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setmaximumDeltaTime", _s_set_maximumDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setmaximumParticleDeltaTime", _s_set_maximumParticleDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "settimeScale", _s_set_timeScale);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcaptureDeltaTime", _s_set_captureDeltaTime);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setcaptureFramerate", _s_set_captureFramerate);
