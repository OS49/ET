...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineGameObjectWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 24, 8, 3);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getactiveSelf", _g_get_activeSelf);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getactiveInHierarchy", _g_get_activeInHierarchy);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Type>(L, 2)) 
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponent( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Type>(L, 2)) 
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentInChildren( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.GetComponentInParent( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<System.Type>(L, 2)) 
                {
                    System.Type _type = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component[] gen_ret = gen_to_be_invoked.GetComponentsInChildren( 
                        _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    UnityEngine.Component _component;
                        ...
                        bool gen_ret = gen_to_be_invoked.TryGetComponent( 
                        _type, 
                        out _component );
		    ...
		    try {
                ...
                
                {
                    string _tag = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.GameObject gen_ret = UnityEngine.GameObject.FindWithTag( 
                        _tag );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SendMessageUpwards(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    ...
                    gen_to_be_invoked.SendMessageUpwards( 
                        _methodName );
		    ...
		    try {
                ...
                
                {
                    System.Type _componentType = (System.Type)translator.GetObject(L, 2, typeof(System.Type));
                        ...
                        UnityEngine.Component gen_ret = gen_to_be_invoked.AddComponent( 
                        _componentType );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _tag = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.GameObject gen_ret = UnityEngine.GameObject.FindGameObjectWithTag( 
                        _tag );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _tag = LuaAPI.lua_tostring(L, 1);
                        ...
                        UnityEngine.GameObject[] gen_ret = UnityEngine.GameObject.FindGameObjectsWithTag( 
                        _tag );
                        translator.Push(L, gen_ret);
