...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.BeginObjectRegister(type, L, translator, 0, 47, 31, 3);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getisPaused", _g_get_isPaused);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getparticleCount", _g_get_particleCount);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettime", _g_get_time);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrandomSeed", _g_get_randomSeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseAutoRandomSeed", _g_get_useAutoRandomSeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getproceduralSimulationSupported", _g_get_proceduralSimulationSupported);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getmain", _g_get_main);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getemission", _g_get_emission);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshape", _g_get_shape);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvelocityOverLifetime", _g_get_velocityOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlimitVelocityOverLifetime", _g_get_limitVelocityOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinheritVelocity", _g_get_inheritVelocity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getforceOverLifetime", _g_get_forceOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolorOverLifetime", _g_get_colorOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolorBySpeed", _g_get_colorBySpeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsizeOverLifetime", _g_get_sizeOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsizeBySpeed", _g_get_sizeBySpeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrotationOverLifetime", _g_get_rotationOverLifetime);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrotationBySpeed", _g_get_rotationBySpeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getexternalForces", _g_get_externalForces);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnoise", _g_get_noise);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcollision", _g_get_collision);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettrigger", _g_get_trigger);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsubEmitters", _g_get_subEmitters);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettextureSheetAnimation", _g_get_textureSheetAnimation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlights", _g_get_lights);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettrails", _g_get_trails);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcustomData", _g_get_customData);

            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settime", _s_set_time);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrandomSeed", _s_set_randomSeed);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseAutoRandomSeed", _s_set_useAutoRandomSeed);
        ...
        static int _m_SetParticles(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2))
                {
                    ...
                    gen_to_be_invoked.SetParticles(
                        _particles);
        ...
        static int _m_GetParticles(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && translator.Assignable<UnityEngine.ParticleSystem.Particle[]>(L, 2))
                {
                    ...
                    int gen_ret = gen_to_be_invoked.GetParticles(
                    _particles);
        ...
        static int _m_SetCustomParticleData(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    gen_to_be_invoked.SetCustomParticleData(
                        _customData,
                        _streamIndex);
        ...
        static int _m_GetCustomParticleData(RealStatePtr L)
        {
            try
            {
...

                {
                    ...
                    int gen_ret = gen_to_be_invoked.GetCustomParticleData(
                    _customData,
                    _streamIndex);
                    LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        static int _m_TriggerSubEmitter(RealStatePtr L)
        {
            try
            {
                ...
                if (gen_param_count == 2 && LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2))
                {
                    ...
                    gen_to_be_invoked.TriggerSubEmitter(
                        _subEmitterIndex);
