...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineDebugWrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 25, 3, 1);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getunityLogger", _g_get_unityLogger);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getdeveloperConsoleVisible", _g_get_developerConsoleVisible);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getisDebugBuild", _g_get_isDebugBuild);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setdeveloperConsoleVisible", _s_set_developerConsoleVisible);
