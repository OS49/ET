...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineCameraWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 142, 57, 44);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnearClipPlane", _g_get_nearClipPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfarClipPlane", _g_get_farClipPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfieldOfView", _g_get_fieldOfView);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderingPath", _g_get_renderingPath);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getactualRenderingPath", _g_get_actualRenderingPath);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowHDR", _g_get_allowHDR);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowMSAA", _g_get_allowMSAA);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getallowDynamicResolution", _g_get_allowDynamicResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getforceIntoRenderTexture", _g_get_forceIntoRenderTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getorthographicSize", _g_get_orthographicSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getorthographic", _g_get_orthographic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getopaqueSortMode", _g_get_opaqueSortMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettransparencySortMode", _g_get_transparencySortMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettransparencySortAxis", _g_get_transparencySortAxis);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdepth", _g_get_depth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getaspect", _g_get_aspect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getvelocity", _g_get_velocity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcullingMask", _g_get_cullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "geteventMask", _g_get_eventMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlayerCullSpherical", _g_get_layerCullSpherical);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcameraType", _g_get_cameraType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getoverrideSceneCullingMask", _g_get_overrideSceneCullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlayerCullDistances", _g_get_layerCullDistances);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseOcclusionCulling", _g_get_useOcclusionCulling);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcullingMatrix", _g_get_cullingMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbackgroundColor", _g_get_backgroundColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclearFlags", _g_get_clearFlags);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getdepthTextureMode", _g_get_depthTextureMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getclearStencilAfterLightingPass", _g_get_clearStencilAfterLightingPass);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getusePhysicalProperties", _g_get_usePhysicalProperties);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getsensorSize", _g_get_sensorSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlensShift", _g_get_lensShift);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getfocalLength", _g_get_focalLength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getgateFit", _g_get_gateFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrect", _g_get_rect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelRect", _g_get_pixelRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelWidth", _g_get_pixelWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpixelHeight", _g_get_pixelHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscaledPixelWidth", _g_get_scaledPixelWidth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscaledPixelHeight", _g_get_scaledPixelHeight);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettargetTexture", _g_get_targetTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getactiveTexture", _g_get_activeTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "gettargetDisplay", _g_get_targetDisplay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcameraToWorldMatrix", _g_get_cameraToWorldMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getworldToCameraMatrix", _g_get_worldToCameraMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getprojectionMatrix", _g_get_projectionMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getnonJitteredProjectionMatrix", _g_get_nonJitteredProjectionMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseJitteredProjectionMatrixForTransparentRendering", _g_get_useJitteredProjectionMatrixForTransparentRendering);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getpreviousViewProjectionMatrix", _g_get_previousViewProjectionMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getscene", _g_get_scene);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstereoEnabled", _g_get_stereoEnabled);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstereoSeparation", _g_get_stereoSeparation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstereoConvergence", _g_get_stereoConvergence);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getareVRStereoViewMatricesWithinSingleCullTolerance", _g_get_areVRStereoViewMatricesWithinSingleCullTolerance);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstereoTargetEye", _g_get_stereoTargetEye);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getstereoActiveEye", _g_get_stereoActiveEye);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcommandBufferCount", _g_get_commandBufferCount);
            
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnearClipPlane", _s_set_nearClipPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfarClipPlane", _s_set_farClipPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfieldOfView", _s_set_fieldOfView);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrenderingPath", _s_set_renderingPath);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowHDR", _s_set_allowHDR);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowMSAA", _s_set_allowMSAA);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setallowDynamicResolution", _s_set_allowDynamicResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setforceIntoRenderTexture", _s_set_forceIntoRenderTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setorthographicSize", _s_set_orthographicSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setorthographic", _s_set_orthographic);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setopaqueSortMode", _s_set_opaqueSortMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settransparencySortMode", _s_set_transparencySortMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settransparencySortAxis", _s_set_transparencySortAxis);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdepth", _s_set_depth);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setaspect", _s_set_aspect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcullingMask", _s_set_cullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "seteventMask", _s_set_eventMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlayerCullSpherical", _s_set_layerCullSpherical);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcameraType", _s_set_cameraType);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setoverrideSceneCullingMask", _s_set_overrideSceneCullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlayerCullDistances", _s_set_layerCullDistances);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseOcclusionCulling", _s_set_useOcclusionCulling);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcullingMatrix", _s_set_cullingMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbackgroundColor", _s_set_backgroundColor);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclearFlags", _s_set_clearFlags);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setdepthTextureMode", _s_set_depthTextureMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setclearStencilAfterLightingPass", _s_set_clearStencilAfterLightingPass);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setusePhysicalProperties", _s_set_usePhysicalProperties);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setsensorSize", _s_set_sensorSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlensShift", _s_set_lensShift);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setfocalLength", _s_set_focalLength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setgateFit", _s_set_gateFit);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrect", _s_set_rect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setpixelRect", _s_set_pixelRect);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settargetTexture", _s_set_targetTexture);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "settargetDisplay", _s_set_targetDisplay);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setworldToCameraMatrix", _s_set_worldToCameraMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setprojectionMatrix", _s_set_projectionMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setnonJitteredProjectionMatrix", _s_set_nonJitteredProjectionMatrix);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseJitteredProjectionMatrixForTransparentRendering", _s_set_useJitteredProjectionMatrixForTransparentRendering);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setscene", _s_set_scene);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstereoSeparation", _s_set_stereoSeparation);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstereoConvergence", _s_set_stereoConvergence);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setstereoTargetEye", _s_set_stereoTargetEye);
		    ...
		    Utils.BeginClassRegister(type, L, __CreateInstance, 28, 7, 3);
			...
			Utils.RegisterFunc(L, Utils.CLS_IDX, "getmain", _g_get_main);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getcurrent", _g_get_current);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getallCamerasCount", _g_get_allCamerasCount);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getallCameras", _g_get_allCameras);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getonPreCull", _g_get_onPreCull);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getonPreRender", _g_get_onPreRender);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "getonPostRender", _g_get_onPostRender);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "setonPreCull", _s_set_onPreCull);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setonPreRender", _s_set_onPreRender);
            Utils.RegisterFunc(L, Utils.CLS_IDX, "setonPostRender", _s_set_onPostRender);
        ...
        static int _m_SetReplacementShader(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetReplacementShader( 
                        _shader, 
                        _replacementTag );
        ...
        static int _m_SetTargetBuffers(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<UnityEngine.RenderBuffer>(L, 2)&& translator.Assignable<UnityEngine.RenderBuffer>(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.SetTargetBuffers( 
                        _colorBuffer, 
                        _depthBuffer );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector4 _clipPlane;translator.Get(L, 2, out _clipPlane);
                        ...
                        UnityEngine.Matrix4x4 gen_ret = gen_to_be_invoked.CalculateObliqueMatrix( 
                        _clipPlane );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.WorldToScreenPoint( 
                        _position );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.WorldToViewportPoint( 
                        _position );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ViewportToWorldPoint( 
                        _position );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ScreenToWorldPoint( 
                        _position );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ScreenToViewportPoint( 
                        _position );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector3 _position;translator.Get(L, 2, out _position);
                        ...
                        UnityEngine.Vector3 gen_ret = gen_to_be_invoked.ViewportToScreenPoint( 
                        _position );
                        translator.PushUnityEngineVector3(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _pos;translator.Get(L, 2, out _pos);
                        ...
                        UnityEngine.Ray gen_ret = gen_to_be_invoked.ViewportPointToRay( 
                        _pos );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 _pos;translator.Get(L, 2, out _pos);
                        ...
                        UnityEngine.Ray gen_ret = gen_to_be_invoked.ScreenPointToRay( 
                        _pos );
                        translator.PushUnityEngineRay(L, gen_ret);
        ...
        static int _m_CalculateFrustumCorners(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.CalculateFrustumCorners( 
                        _viewport, 
                        _z, 
                        _eye, 
                        _outCorners );
        ...
        static int _m_CalculateProjectionMatrixFromPhysicalProperties_xlua_st_(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 7&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& translator.Assignable<UnityEngine.Vector2>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)&& translator.Assignable<UnityEngine.Camera.GateFitParameters>(L, 7)) 
                {
                    UnityEngine.Matrix4x4 _output;
                    float _focalLength = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.Vector2 _sensorSize;translator.Get(L, 3, out _sensorSize);
                    UnityEngine.Vector2 _lensShift;translator.Get(L, 4, out _lensShift);
                    float _nearClip = (float)LuaAPI.lua_tonumber(L, 5);
                    float _farClip = (float)LuaAPI.lua_tonumber(L, 6);
                    UnityEngine.Camera.GateFitParameters _gateFitParameters;translator.Get(L, 7, out _gateFitParameters);
                ...
                if(gen_param_count == 6&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.Vector2>(L, 3)&& translator.Assignable<UnityEngine.Vector2>(L, 4)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 5)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 6)) 
                {
                    UnityEngine.Matrix4x4 _output;
                    float _focalLength = (float)LuaAPI.lua_tonumber(L, 2);
                    UnityEngine.Vector2 _sensorSize;translator.Get(L, 3, out _sensorSize);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _sensorSize = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = UnityEngine.Camera.FocalLengthToFieldOfView( 
                        _focalLength, 
                        _sensorSize );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _sensorSize = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = UnityEngine.Camera.FieldOfViewToFocalLength( 
                        _fieldOfView, 
                        _sensorSize );
                        LuaAPI.lua_pushnumber(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _aspectRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = UnityEngine.Camera.HorizontalToVerticalFieldOfView( 
		    ...
		    try {
                ...
                
                {
                    ...
                    float _aspectRatio = (float)LuaAPI.lua_tonumber(L, 2);
                        ...
                        float gen_ret = UnityEngine.Camera.VerticalToHorizontalFieldOfView( 
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Camera.StereoscopicEye _eye;translator.Get(L, 2, out _eye);
                        ...
                        UnityEngine.Matrix4x4 gen_ret = gen_to_be_invoked.GetStereoNonJitteredProjectionMatrix( 
                        _eye );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Camera.StereoscopicEye _eye;translator.Get(L, 2, out _eye);
                        ...
                        UnityEngine.Matrix4x4 gen_ret = gen_to_be_invoked.GetStereoViewMatrix( 
                        _eye );
                        translator.Push(L, gen_ret);
        ...
        static int _m_CopyStereoDeviceProjectionMatrixToNonJittered(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.CopyStereoDeviceProjectionMatrixToNonJittered( 
                        _eye );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Camera.StereoscopicEye _eye;translator.Get(L, 2, out _eye);
                        ...
                        UnityEngine.Matrix4x4 gen_ret = gen_to_be_invoked.GetStereoProjectionMatrix( 
                        _eye );
                        translator.Push(L, gen_ret);
        ...
        static int _m_SetStereoProjectionMatrix(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetStereoProjectionMatrix( 
                        _eye, 
                        _matrix );
        ...
        static int _m_SetStereoViewMatrix(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.SetStereoViewMatrix( 
                        _eye, 
                        _matrix );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Camera[] _cameras = (UnityEngine.Camera[])translator.GetObject(L, 1, typeof(UnityEngine.Camera[]));
                        ...
                        int gen_ret = UnityEngine.Camera.GetAllCameras( 
                        _cameras );
		    ...
		    try {
                ...
                if(gen_param_count == 2&& translator.Assignable<UnityEngine.Cubemap>(L, 2)) 
                {
                    UnityEngine.Cubemap _cubemap = (UnityEngine.Cubemap)translator.GetObject(L, 2, typeof(UnityEngine.Cubemap));
                        ...
                        bool gen_ret = gen_to_be_invoked.RenderToCubemap( 
                        _cubemap );
        ...
        static int _m_RenderWithShader(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RenderWithShader( 
                        _shader, 
                        _replacementTag );
        ...
        static int _m_RemoveCommandBuffers(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.RemoveCommandBuffers( 
                        _evt );
        ...
        static int _m_AddCommandBuffer(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.AddCommandBuffer( 
                        _evt, 
                        _buffer );
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Rendering.CameraEvent _evt;translator.Get(L, 2, out _evt);
                        ...
                        UnityEngine.Rendering.CommandBuffer[] gen_ret = gen_to_be_invoked.GetCommandBuffers( 
                        _evt );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2) 
                {
                    UnityEngine.Rendering.ScriptableCullingParameters _cullingParameters;
                        ...
                        bool gen_ret = gen_to_be_invoked.TryGetCullingParameters( 
                        out _cullingParameters );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 3&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 2)) 
                {
