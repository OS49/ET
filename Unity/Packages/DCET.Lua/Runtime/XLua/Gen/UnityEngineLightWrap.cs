...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineLightWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 64, 29, 28);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getspotAngle", _g_get_spotAngle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getinnerSpotAngle", _g_get_innerSpotAngle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolor", _g_get_color);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcolorTemperature", _g_get_colorTemperature);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getintensity", _g_get_intensity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbounceIntensity", _g_get_bounceIntensity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseBoundingSphereOverride", _g_get_useBoundingSphereOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getboundingSphereOverride", _g_get_boundingSphereOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowCustomResolution", _g_get_shadowCustomResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowBias", _g_get_shadowBias);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowNormalBias", _g_get_shadowNormalBias);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowNearPlane", _g_get_shadowNearPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getuseShadowMatrixOverride", _g_get_useShadowMatrixOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowMatrixOverride", _g_get_shadowMatrixOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrange", _g_get_range);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getflare", _g_get_flare);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getbakingOutput", _g_get_bakingOutput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcullingMask", _g_get_cullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderingLayerMask", _g_get_renderingLayerMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlightShadowCasterMode", _g_get_lightShadowCasterMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadows", _g_get_shadows);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowStrength", _g_get_shadowStrength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getshadowResolution", _g_get_shadowResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getlayerShadowCullDistances", _g_get_layerShadowCullDistances);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcookieSize", _g_get_cookieSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getcookie", _g_get_cookie);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "getrenderMode", _g_get_renderMode);
            ...
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setspotAngle", _s_set_spotAngle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setinnerSpotAngle", _s_set_innerSpotAngle);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcolor", _s_set_color);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcolorTemperature", _s_set_colorTemperature);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setintensity", _s_set_intensity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbounceIntensity", _s_set_bounceIntensity);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseBoundingSphereOverride", _s_set_useBoundingSphereOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setboundingSphereOverride", _s_set_boundingSphereOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowCustomResolution", _s_set_shadowCustomResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowBias", _s_set_shadowBias);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowNormalBias", _s_set_shadowNormalBias);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowNearPlane", _s_set_shadowNearPlane);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setuseShadowMatrixOverride", _s_set_useShadowMatrixOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowMatrixOverride", _s_set_shadowMatrixOverride);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrange", _s_set_range);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setflare", _s_set_flare);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setbakingOutput", _s_set_bakingOutput);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcullingMask", _s_set_cullingMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrenderingLayerMask", _s_set_renderingLayerMask);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlightShadowCasterMode", _s_set_lightShadowCasterMode);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadows", _s_set_shadows);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowStrength", _s_set_shadowStrength);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setshadowResolution", _s_set_shadowResolution);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setlayerShadowCullDistances", _s_set_layerShadowCullDistances);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcookieSize", _s_set_cookieSize);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setcookie", _s_set_cookie);
            Utils.RegisterFunc(L, Utils.METHOD_IDX, "setrenderMode", _s_set_renderMode);
		    ...
		    try {
                ...
                
                {
                    ...
                    int _layer = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        UnityEngine.Light[] gen_ret = UnityEngine.Light.GetLights( 
                        _type, 
                        _layer );
                        translator.Push(L, gen_ret);
